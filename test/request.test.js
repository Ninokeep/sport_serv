...
describe('/sportif requests', () => {
  //beforeEach(resetDatabase);

  describe('GET /books', () => {
    beforeEach(async () => {
      await Sportif.create({ email:"fabrizio@gmail.com", nom: 'test mocha', prenom: 'test' , password:"12345678", poids:86, sexe: true, niveau :"debutant", age: 27 });
    });
  ...
  //   beforeEach(async () => {
  //     sportif = await Sportif.create({ title: 'Other title', author: 'Other author' });
  //   });
