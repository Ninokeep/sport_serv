...
//     })
// }),
    describe("POST /kine/create-entrainement ", function(){
        it('doit créer un objet entraînement', function(done){
            var entrainement = {
                'nom':"main",
                'niveau': 'debutant',
                'gif': null,
                'commentaire': 'un entraînement sympa',
                'id_kine': 5
            }
            request(app)
            .post('/kine/create-entrainement')
            .send(entrainement)
            .expect(201,done)
        })
    });
